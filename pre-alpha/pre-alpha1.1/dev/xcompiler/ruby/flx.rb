#!/usr/bin/ruby
# ============================================================================
VERSION = "flx.rb Freelang cross compiler version pre-alpha-0.0.0.1 for FVM 1.1"
# ============================================================================
# Program:    flx.rb
# Copyright © Robert Gollagher 2015
# Author :    Robert Gollagher   robert.gollagher@freeputer.net
# Created:    20150329
# Updated:    20160314:1620
...
#
# WARNING: This is a new, experimental version of the flx cross-compiler
# for the Freelang programming language and it is specifically intended to be
# compile programs for FVM 1.1 (not yet publicly available) rather than FVM 1.0.
# Nevertheless it should work for compiling programs for FVM 1.0 providing
# the Freelang program you are compiling does not use any of the new
# instructions supported only by FVM 1.1. This is because FVM 1.1 is
# backward-compatible with FVM 1.0 bytecode; that is, FVM 1.1 uses a superset
# of FVM 1.0 bytecode. The only advantage you might gain from using
# this experimental version of flx to compile FVM 1.0 programs is that
# it now allows not only a label reference but alternatively a constant
# reference or a slot reference to be used in complex instructions;
# that can be quite helpful for advanced programming techniques.
# ============================================================================
